	...
	<div id="header">
		...
		<script type="text/javascript">
			$(function () {
				...
				// 给【输入框】绑定 onchange内容发生改变事件
				$(".updateCount").change(function () {
					// 获取商品名称
					var name = $(this).parent().parent().find("td:first").text();
					var id = $(this).attr('sushiId');
					// 获取商品数量
					var count = this.value;
					if ( confirm("你确定要将【" + name + "】商品修改数量为：" + count + " 吗?") ) {
						//发起请求。给服务器保存修改
						location.href = "http://localhost:8080/takeaway/cart?action=updateCount&count="+count+"&id="+id;
					} else {
